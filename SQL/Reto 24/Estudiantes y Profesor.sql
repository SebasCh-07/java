...
select pr.codigo, est.nombre, est.apellido from profesores pr, estudiantes est
where est.apellido like '%n%' or est.apellido like '%n' 

select * from estudiantes
where codigo_profesor = (select codigo from profesores where nombre like 'Francisco%')
