...
values(1,'Snacks SA','0992920303');
insert into proveedores(codigo,nombre,telefono)
values(2,'Distrisnacks','0992984666')
...
where pp.pp_codigo_producto = prod.codigo and pp.pp_codigo_proveedor = prov.codigo and prod.codigo = 300
