...
where vi.descripcion = 'Guerra' and vi.valoracion > 7 or vi.nombre like 'C%' and vi.valoracion > 8 and vi.nombre like 'D%'

select * from plataformas 
where codigo_videojuego = (select codigo from videojuegos where nombre ilike 'God of War')
